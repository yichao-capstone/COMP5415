...
st.title('Image Map')
st.write('You have to install `streamlit_image_coordinates` on your computer')

if st.toggle('Show code of `point_in_rect`', value=False):
    st.code('''def point_in_rect(x, y, rect, inclusive=True, tol=0.0):
    x1, y1, x2, y2 = rect
